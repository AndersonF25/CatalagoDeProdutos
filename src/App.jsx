...
function App() {
  ...
  const handleAddCart = (product, quantity) => {
    // Define uma função chamada handleAddCart que aceita dois parâmetros: product e quantity

    setCart((previtems) => {
      // Chama a função setCart para atualizar o estado do carrinho, passando uma função de retorno de chamada que recebe o estado anterior do carrinho como previtems
      ...
      if (itensExists) {
        // Se um item com o mesmo id já existe no carrinho
        ...
        // Se nenhum item com o mesmo id existe no carrinho
    ...
    <BrowserRouter>
      ...
      <div className="container-routes">
        <Routes>
          ...
          <Route path="/thank-you" element={<Thanks cart={cart} />} />
        </Routes>
      </div>
